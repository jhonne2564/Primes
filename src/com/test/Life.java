...
public class Life  extends TestPerfilTic
{
...
//		super();
	...
	public static void main(String[] args) {
		...
		String h="holafadsfasf";
		for (int i = 1; i < h.length(); i++) {
			System.out.println(h.substring(0,i)+"-"+h.substring(i, h.length()));
		}
	 ...
	 public static int fillMissingBrackets(String s) {
	        ...
	        for(int i=1;i<s.length();i++){
	            if(accept(s.substring(0,i))&&accept(s.substring(i,s.length()))){
	                cont++;
	            }
	        }
	        return cont;
	    }
	    public static boolean accept(String part){
	        int a=0;//counter []
	        int b=0;//counter ()
	        int c=0;//counter ?
